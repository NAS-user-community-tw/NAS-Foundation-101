...
資訊安全 並不是 買二台 NAS 或者 買一台防火牆 這麼單純 . 更別說只有一台 NAS (或者沒有 NAS 或者任何檔案[備份](https://zh.wikipedia.org/wiki/%E5%A4%87%E4%BB%BD)機制的情況) . NAS 裡面因為有 作業系統 / 伺服器套件 / 使用者端軟體 等等的組合協助之下 , 因此比起一般 人工手動備份 , 多了許多機制以及選項 . 無論 個人 / 家庭 / 企業組織 , 都應該預先考慮 [備份 3-2-1 法則](https://www.ithome.com.tw/tech/101369) . 實務上來說 , 一開始可能沒有辦法完全做到 , 後續要盡量往這個目標前進 , 依據個別的 預算編列 / 環境條件 , 保持不只一份資料實體的狀態 , 這樣才能防止 單一資料受損 , 甚至遺失的痛苦遭遇 . 
